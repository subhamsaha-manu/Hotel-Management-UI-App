...
export class InvoiceComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    console.log(this.existingBooking.totalNoOfGuests);
  }
  ...
  print() {
    let docDefinition = {
      content: [
        ...
        },
        {
          table: {
            ...
            body: [
              ...
              ...this.existingBooking.roomDetails.map((ele, index) => [
                index + 1,
                ele.roomType,
                ele.roomSize,
                ele.roomNumber,
                ele.noOfPersons,
                { text: ele.roomCost, alignment: 'center' },
              ]),
              //[1,this.existingBooking.roomType,this.existingBooking.,this.existingBooking.roomNumber,5000],
              [
                { text: 'Total Payable Amount', colSpan: 5 },
                {},
                {},
                {},
                {},
                {
                  text: this.existingBooking.totalPayableAmount,
                  alignment: 'center',
                },
              ],
            ],
        ...
        },
        {
          table: {
            ...
            body: [
              ...
              ...this.existingBooking.paymentDetails.map((ele, index) => [
                index + 1,
                ele.paymentDate,
                ele.paymentMode,
                ele.paymentAmount,
        ...
        {
          ul: ['This is system generated invoice.'],
        },
      ],
      styles: {
        sectionHeader: {
